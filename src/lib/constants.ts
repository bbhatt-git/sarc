...
export const GALLERY_IMAGES = [
    ...
    { src: '/images/gallery/16.jpg', category: 'Campus Life', hint: 'student life' },
    { src: '/images/gallery/17.jpg', category: 'Events', hint: 'guest lecture' },
    { src: '/images/gallery/18.jpg', category: 'Academics', hint: 'computer lab' },
    { src: '/images/gallery/19.jpg', category: 'Sports', hint: 'volleyball match' },
    { src: '/images/gallery/20.jpg', category: 'Campus Life', hint: 'canteen friends' },
    { src: '/images/gallery/21.jpg', category: 'Community', hint: 'social work' },
    { src: '/images/gallery/22.jpg', category: 'Events', hint: 'annual day' },
    { src: '/images/gallery/23.jpg', category: 'Academics', hint: 'library study' },
    { src: '/images/gallery/24.jpg', category: 'Sports', hint: 'cricket tournament' },
    { src: '/images/gallery/25.jpg', category: 'Campus Life', hint: 'group project' },
    { src: '/images/gallery/26.jpg', category: 'Community', hint: 'planting trees' },
    { src: '/images/gallery/27.jpg', category: 'Events', hint: 'science fair' },
    { src: '/images/gallery/28.jpg', category: 'Academics', hint: 'chemistry lab' },
    { src: '/images/gallery/29.jpg', category: 'Sports', hint: 'table tennis' },
    { src: '/images/gallery/30.jpg', category: 'Campus Life', hint: 'university building' },
    { src: '/images/gallery/31.jpg', category: 'Community', hint: 'awareness rally' },
    { src: '/images/gallery/32.jpg', category: 'Events', hint: 'cultural festival' },
    { src: '/images/gallery/33.jpg', category: 'Academics', hint: 'art class' },
    { src: '/images/gallery/34.jpg', category: 'Sports', hint: 'chess competition' },
    { src: '/images/gallery/35.jpg', category: 'Campus Life', hint: 'graduation day' },
    { src: '/images/gallery/36.jpg', category: 'Community', hint: 'charity event' },
    { src: '/images/gallery/37.jpg', category: 'Events', hint: 'music concert' },
    { src: '/images/gallery/38.jpg', category: 'Academics', hint: 'physics experiment' },
    { src: '/images/gallery/39.jpg', category: 'Sports', hint: 'badminton court' },
    { src: '/images/gallery/40.jpg', category: 'Campus Life', hint: 'students walking' },
];
