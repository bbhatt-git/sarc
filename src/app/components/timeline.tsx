      ...
      <div ref={ref} className="relative max-w-3xl mx-auto py-8">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex-col md:flex-row z-10 items-center top-40 self-start hidden md:flex md:w-40">
              ...
              <h3 className="text-4xl font-bold text-muted-foreground text-right w-full pr-8">
                {item.title}
              </h3>
            </div>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-emerald-500 via-sky-500 to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
