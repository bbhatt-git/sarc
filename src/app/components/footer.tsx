        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 pt-2">
              <Link href="#" className="text-slate-400 hover:text-blue-500 transition-colors"><Facebook size={20} /></Link>
              <Link href="#" className="text-slate-400 hover:text-blue-500 transition-colors"><Twitter size={20} /></Link>
              <Link href="#" className="text-slate-400 hover:text-blue-500 transition-colors"><Instagram size={20} /></Link>
              <Link href="#" className="text-slate-400 hover:text-blue-500 transition-colors"><Linkedin size={20} /></Link>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {NAV_LINKS.slice(0, 4).map(link => (
                <li key={link.label}>
                  <Link href={link.href || '#'} className="text-sm text-slate-400 hover:text-blue-500 transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
              <li><Link href="/gallery" className="text-sm text-slate-400 hover:text-blue-500 transition-colors">Gallery</Link></li>
              <li><Link href="/contact" className="text-sm text-slate-400 hover:text-blue-500 transition-colors">Contact</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-400">
              <li className='flex items-start gap-3'>
                <MapPin size={16} className='mt-1 shrink-0 text-blue-500/70' />
                <span>Padma Kanya Multiple Campus, Bagbazar, Kathmandu, Nepal</span>
              </li>
              <li className='flex items-center gap-3'>
                <Phone size={16} className='shrink-0 text-blue-500/70'/>
                <a href="tel:+97714242424" className="hover:text-blue-500 transition-colors">+977-1-4242424</a>
              </li>
              <li className='flex items-center gap-3'>
                <Mail size={16} className='shrink-0 text-blue-500/70'/>
                <a href="mailto:info@sarc.edu.np" className="hover:text-blue-500 transition-colors">info@sarc.edu.np</a>
              </li>
            </ul>
          </div>
