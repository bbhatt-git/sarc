            ...
            <div className="py-16 lg:py-24">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-3 gap-8 md:gap-12 glass-card p-8 rounded-2xl">
                            <div className="md:col-span-1 flex flex-col items-center text-center">
                                ...
                                <h1 className="text-2xl font-bold font-headline">{staffMember.name}</h1>
                                <p className="text-primary font-medium">{staffMember.designation}</p>
                                <Badge variant="secondary" className="mt-2 bg-primary/10 text-primary-foreground/80">{staffMember.credentials}</Badge>
                            </div>
